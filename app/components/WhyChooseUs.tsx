  ...
  return (
    ...
    >
      ...
      <div className="w-86 sm:w-[95vw] max-w-[95vw] sm:max-w-165 md:max-w-220 mx-auto mt-25 mb-20 sm:mt-18 sm:mb-25">
        <h1 className="text-center text-[27px] sm:text-4xl font-bold uppercase tracking-wider text-background mb-11">
          Why Choose Us?
        </h1>
        <div className="flex flex-col sm:flex-row sm:items-center gap-9 sm:gap-10">
          <div className="w-full h-53 sm:w-58 sm:h-full sm:order-2 md:w-76 md:h-70">
            <Image
              src={whyChooseUsImg}
              alt="A man fixing an air conditioner on a roof"
              loading="eager"
          ...
          <p className="w-full sm:flex-1 sm:text-right text-sm md:text-base leading-5.25 md:leading-5.75 font-light text-background">
            At Samsung Appliance Repair & Services, we&apos;re not just another
            repair company, we&apos;re a name homeowners can rely on. We
            understand what you need when your refrigerator, washing machine,
            TV, water purifier, or air conditioner stops working. Our skilled
            technicians work quickly and efficiently to get your appliances back
            in shape, so your home keeps running the way it should.{" "}
            <span className="font-semibold">
              We treat every customer like a neighbor
            </span>
            , not just another booking, and back every repair with genuine parts
            and a real warranty. When your appliances give up, trust Samsung
            Appliance Repair & Services to set things right.
          </p>
        </div>
      </div>
    </section>
